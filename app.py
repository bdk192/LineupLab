...
def load_participation(seasons):
    ...
    return nfl.load_participation(seasons).to_pandas()
...
warnings = warnings + referee_warnings + pressure_warnings + scheme_warnings
...
tab1, tab2, tab3, tab4, tab5 = st.tabs([
    ...
    "O-line/pressure signal", "Defensive scheme signal",
])
